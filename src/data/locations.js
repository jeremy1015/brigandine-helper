...
export default {
  ...
  isleOfMartha: {
    name: 'Isle of Martha',
    type: lt.isleOfMartha,
    rewards: [rt.rod, rt.monsterLeather, rt.claws, rt.hat, rt.crystal],

  },
  isleOfSeymour: {
    name: 'Isle of Seymour',
    type: lt.isleOfSeymour,
    rewards: [rt.staff, rt.helmet, rt.sword, rt.robe, rt.consumable],

  },
  isleOfTrembo: {
    name: 'Isle of Trembo',
    type: lt.isleOfTrembo,
    rewards: [rt.longsword, rt.monsterMail, rt.teeth, rt.bracer, rt.consumable],

  },
  ivoryDragonSpring: {
    name: 'Ivory Dragon Spring',
    type: lt.ivoryDragonSpring,
    rewards: [rt.spear, rt.helmet, rt.mail, rt.accessory, rt.consumable],
  ...
  poudValley: {
    name: 'Poud Valley',
    type: lt.poudValley,
    rewards: [rt.spear, rt.fist, rt.monsterHelmet, rt.monsterMail, rt.chalice],
  ...
  theManaSpring: {
    ...
    type: lt.theManaSpring,
    rewards: [rt.sword, rt.monsterAccessory, rt.monsterRobe, rt.monsterHat, rt.crystal],
  ...
  hiddenTreasury: {
    ...
    type: lt.hiddenTreasury,
    rewards: [rt.longsword, rt.helmet, rt.pearl, rt.robe, rt.consumable],
